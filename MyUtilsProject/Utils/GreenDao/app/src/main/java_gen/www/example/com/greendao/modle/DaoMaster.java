...
public class DaoMaster extends AbstractDaoMaster {
    ...
    private static SQLiteOpenHelper mDevOpenHelper;
    private static final String DABASE_FILE_NAME = "FOOD.db";
    public static synchronized SQLiteOpenHelper getSQLiteDatabaseInstance(Context context){
        if (mDevOpenHelper == null) {
            mDevOpenHelper = new DevOpenHelper(context, DABASE_FILE_NAME, null);
        }
        return mDevOpenHelper;
    }

    /** WARNING: Drops all table on Upgrade! Use only during development. */
    private static class DevOpenHelper extends OpenHelper {
